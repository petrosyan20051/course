namespace db.Custom_Classes {
    public static class SqlConnect {
        public static string? GetConnectionString(string? ip, string? dbName, string? login, string? password, bool isTrustedConnection = true, bool trustServerSertificate = true) {
